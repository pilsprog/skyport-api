...
/**
 * 
 * A testgame that starts two Randomplayers and a graphical interface and
 * connects it to the game server.
 * 
 * @author Bjarte
 * 
 */
public class TestGame {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // MockGraphicsClient graphics = new MockGraphicsClient("localhost",
        // 54331);
